...
import com.teixeira.subtitles.databinding.FragmentDialogConfigureProjectBinding;
...
public class ConfigureProjectDialogFragment extends DialogFragment {

  public static ConfigureProjectDialogFragment newInstance() {
    return newInstance(null);
  }

  public static ConfigureProjectDialogFragment newInstance(Project project) {
    ConfigureProjectDialogFragment fragment = new ConfigureProjectDialogFragment();
    if (project != null) {
  ...
  private FragmentDialogConfigureProjectBinding binding;
  ...
  public Dialog onCreateDialog(Bundle savedInstanceState) {
    ...
    binding = FragmentDialogConfigureProjectBinding.inflate(sheetDialog.getLayoutInflater());
  ...
  private void setListeners() {
    binding.chooseVideo.setOnClickListener(v -> videoPicker.launch(new String[] {"video/*"}));
