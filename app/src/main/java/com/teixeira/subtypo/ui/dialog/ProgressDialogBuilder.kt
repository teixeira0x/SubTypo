...
package com.teixeira.subtypo.ui.dialog
...
import com.teixeira.subtypo.databinding.LayoutProgressDialogBinding
...
class ProgressDialogBuilder(val context: Context) {
  ...
  fun setCancelable(cancelable: Boolean) = apply { builder.setCancelable(cancelable) }
