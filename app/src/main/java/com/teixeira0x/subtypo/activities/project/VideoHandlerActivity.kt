...
abstract class VideoHandlerActivity : ProjectHandlerActivity() {
  ...
  private fun configureListeners() {
    ...
    binding.controllerContent.seekBar.setOnSeekBarChangeListener(
      object : SeekBar.OnSeekBarChangeListener {
        ...
        override fun onProgressChanged(
          ...
          if (fromUser)
            videoViewModel.setCurrentPosition(progress.toLong(), true)
        }
    ...
    binding.controllerContent.undo.setOnClickListener {
      subtitlesViewModel.undo()
    }
    binding.controllerContent.redo.setOnClickListener {
      subtitlesViewModel.redo()
    }
    ...
    binding.controllerContent.changeSubtitle.setOnClickListener {
      showSubtitleSelectorDialog()
    }
  ...
  private fun onVideoPrepared(player: ExoPlayer) {
    ...
    if (videoViewModel.isPrepared.not()) { // The first preparation of the video
      ...
      binding.controllerContent.videoDuration.setText(
