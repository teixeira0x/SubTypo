...
class ProjectListAdapter(
  ...
  override fun onBindViewHolder(holder: ProjectViewHolder, position: Int) {
    holder.binding.apply {
      ...
      videoIcon.setImageBitmap(com.teixeira0x.subtypo.utils.VideoUtils.getVideoThumbnail(project.videoPath))
  ...
  private fun toggleOptionsVisibility(optionsContainer: FrameLayout, chevron: ImageView) {
    ...
    com.teixeira0x.subtypo.utils.UiUtils.rotateView(chevron, if (optionsContainer.isVisible) 0f else DEFAULT_CHEVRON_ROTATION)
  }
