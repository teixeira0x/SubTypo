...
class ProjectEditorFragment : BaseBottomSheetFragment() {
  ...
  override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
    ...
    if (isExistingProject) {
      binding.videoIcon.setImageBitmap(com.teixeira0x.subtypo.utils.VideoUtils.getVideoThumbnail(project!!.videoPath))
  ...
  private fun onChooseVideo(uri: Uri?) {
    if (uri != null) {
      ...
      binding.videoIcon.setImageBitmap(com.teixeira0x.subtypo.utils.VideoUtils.getVideoThumbnailFromUri(uri))
  ...
  private fun createProject() {
    ...
    when {
      videoUri == null -> com.teixeira0x.subtypo.utils.ToastUtils.showShort(R.string.error_choose_video)
      name.isEmpty() -> com.teixeira0x.subtypo.utils.ToastUtils.showShort(R.string.error_enter_name)
