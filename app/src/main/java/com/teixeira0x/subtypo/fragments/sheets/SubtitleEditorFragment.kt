...
class SubtitleEditorFragment : BaseBottomSheetFragment() {
  ...
  companion object {
    ...
    fun newInstance(subtitleIndex: Int = -1): SubtitleEditorFragment {
      return SubtitleEditorFragment().also {
        it.arguments =
          Bundle().apply { putInt(KEY_SUBTITLE_INDEX, subtitleIndex) }
      }
    }
  }
  ...
  override fun onCreateView(
    ...
    return FragmentDialogSubtitleEditorBinding.inflate(inflater)
      .also { _binding = it }
      .root
  }
  ...
  override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
    ...
    binding.title.setText(
      if (isEditingSubtitle) R.string.proj_subtitle_edit
      else R.string.proj_subtitle_add
    )
  ...
  private fun onSave() {
    ...
    subtitle.apply {
      ...
      subtitleFormat =
        SubtitleFormat.Builder.from(binding.tieFormat.text.toString()).build()
    }
