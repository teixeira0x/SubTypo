      ...
      try {
        ...
        withContext(Dispatchers.Main) {
          if (text == null || text.trim().isEmpty()) {
            com.teixeira0x.subtypo.utils.ToastUtils.showLong(R.string.proj_import_subtitle_error)
            return@withContext
          }
          ...
          com.teixeira0x.subtypo.utils.ToastUtils.showLong(R.string.proj_import_subtitle_success)
        }
      } catch (ioe: Exception) {
        withContext(Dispatchers.Main) { com.teixeira0x.subtypo.utils.ToastUtils.showLong(R.string.proj_import_subtitle_error) }
      }
    }
  }
}
